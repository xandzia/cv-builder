  ...
  return (
    <label className="block">
      ...
      <textarea
        ...
        className={`w-full rounded-md border px-3 py-2 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-1 outline-none transition-colors resize-y min-h-[60px] ${
          error
